...
# bot msgs
MISUNDERSTANDING = [
    """Um. I don't recognize it. Which operation do you want to do? Save, update, delete or get some information? (say 'help' for samples)"""
    ,
...
HELP = [
    """I'm a bot that helps you save your information in an organized, secure, and flexible way. Say what you want to save, update, delete or only get info. \nFor example, say something like 'save a class with name=Self-Adaptive Systems', 'view classes', or 'delete class name=Java'."""
    ,
